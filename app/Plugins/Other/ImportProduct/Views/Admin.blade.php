          ...
          <div class="box">
            <div class="box-header with-border">
                <div class="btn-group pull-right">
                    <a href="{{ route('admin_product.index') }}" class="btn btn-sm btn-flat btn-default"><i class="fa fa-list"></i>&nbsp;{{ trans('product.admin.title') }}</a>
                </div>
              </div>
              <div class="box-body">

              <form action="{{ route('admin_import_product.process_import') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product" enctype="multipart/form-data">
                  @csrf
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-6">
                                  <div class="input-group">
                                    <span class=" {{ $errors->has('file') ? ' has-error' : '' }}">
                                        <input accept="application/vnd.ms-excel" type="file" required="required" name="file" class="form-control " placeholder="" >
                                    </span>
...
<hr>
              ...
              <form action="{{ route('admin_import_product.process_import_info') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product-des" enctype="multipart/form-data">
                @csrf
                ...
                <div class="box-body">
                    <div class="fields-group">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="input-group">
                                  <span class=" {{ $errors->has('file_info') ? ' has-error' : '' }}">
                                      <input accept="application/vnd.ms-excel" type="file" required="required" name="file_info" class="form-control " placeholder="" >
                                  </span>
                                    <div class="btn input-group-addon button-upload-des">
                                        <i class="fa fa-floppy-o" aria-hidden="true"></i> {{ $import_submit }}
                                    </div>
                                </div>
                                <div class="{{ $errors->has('file_info') ? ' has-error' : '' }}">
            ...
            <form action="{{ route('admin_import_product.process_import_promotion') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product-promotion" enctype="multipart/form-data">
              @csrf
              ...
              <div class="box-body">
                  <div class="fields-group">
                      <div class="form-group">
                          ...
                          <div class="col-sm-6">
                              <div class="input-group">
                                <span class=" {{ $errors->has('file_promotion') ? ' has-error' : '' }}">
                                    <input accept="application/vnd.ms-excel" type="file" required="required" name="file_promotion" class="form-control " placeholder="" >
                                </span>
                                  <div class="btn input-group-addon button-upload-promotion">
                                      <i class="fa fa-floppy-o" aria-hidden="true"></i> {{ $import_submit }}
                                  </div>
                              </div>
                              <div class="{{ $errors->has('file_promotion') ? ' has-error' : '' }}">
          ...
          <form action="{{ route('admin_import_product.process_import_build') }}" method="post" accept-charset="UTF-8" class="form-horizontal" id="import-product-build" enctype="multipart/form-data">
            @csrf
            ...
            <div class="box-body">
                <div class="fields-group">
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            <div class="input-group">
                              <span class=" {{ $errors->has('file_build') ? ' has-error' : '' }}">
                                  <input accept="application/vnd.ms-excel" type="file" required="required" name="file_build" class="form-control " placeholder="" >
                              </span>
                                <div class="btn input-group-addon button-upload-build">
                                    <i class="fa fa-floppy-o" aria-hidden="true"></i> {{ $import_submit }}
                                </div>
                            </div>
                            <div class="{{ $errors->has('file_build') ? ' has-error' : '' }}">

...
class AppConfig extends ConfigDefault
{
            ...
            AdminConfig::insert(
                [
                    ...
                    */
                    ...
                    'sort' => 0, // int value
                    'value' => '<a href="'.route('admin.home').'/import_product" target="_new"><span class="btn btn-success btn-flat"><i class="fa fa-floppy-o" aria-hidden="true"></i> Import</span></a>', // allow html or view::path_to_view
                    'detail' => '',
                ]
            );
            if (!$process) {
    ...
    {
        return redirect(route('admin.home').'/import_product');
    }

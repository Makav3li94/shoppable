                            ...
                            @foreach ($languages as $code => $language)
                                ...
                                <div class="form-group   {{ $errors->has('descriptions.'.$code.'.title') ? ' has-error' : '' }}">
                                    <label for="{{ $code }}__title"
                                           class="col-sm-2 col-form-label">{{ trans('page.title') }} <span class="seo"
                                                                                                           title="SEO"><i
                                ...
                                <div
                                    ...
                                    <label for="{{ $code }}__keyword"
                                           class="col-sm-2 col-form-label">{{ trans('page.keyword') }} <span class="seo"
                                                                                                             title="SEO"><i
                                                    class="fa fa-coffee" aria-hidden="true"></i></span></label>
                                    <div class="col-sm-8">
                                        <div class="input-group">
                                ...
                                <div
                                    ...
                                    <label for="{{ $code }}__description"
                                           class="col-sm-2 col-form-label">{{ trans('page.description') }} <span

    ...
    <div class="row">
        <div class="col-md-12">
            <div class="box">
                ...
                <!-- /.box-header -->
                <!-- form start -->
                <form action="{{ route('admin_product.edit',['id'=>$product['id']]) }}" method="post"
                            ...
                            @foreach ($languages as $code => $language)
                                ...
                                <div
                                    ...
                                    <textarea id="{{ $code }}__description"
                                              ...
                                              placeholder=""/>{{ old('descriptions.'.$code.'.description',($descriptions[$code]['description']??'')) }}</textarea>
                            ...
                            @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                ...
                                <div class="form-group  kind kind0 kind1 {{ $errors->has('category') ? ' has-error' : '' }}">
                                    ...
                                    <div class="col-sm-8">
                                        ...
                                        <input type="hidden" id="cat_manager_org" name="cat_manager_org"
                                               value="{{$cats}}"/>
                                    </div>
                                </div>
                            @endif
                                ...
                                <div class="col-sm-8">
                                    <div class="input-group">
                                        ...
                                        <input type="text" id="alias" name="alias"
                                               ...
                                               class="form-control input-sm alias"
                                               placeholder=""/>
                                    </div>
                                    @if ($errors->has('alias'))
                                        <span class="help-block">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="cost" name="cost"
                                                       ...
                                                       class="form-control input-sm cost"
                                                       placeholder=""/>
                                            </div>
                                            @if ($errors->has('cost'))
                                                <span class="help-block">
                                                ...
                                                <div class="price_promotion">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="number" style="width: 100px;" id="price_promotion"
                                                               ...
                                                               class="form-control input-sm price_promotion"
                                                               placeholder=""/>
                                                        <span title="Remove"
                                                ...
                                                <span class="input-group-addon">
                                                    <i class="fa fa-clock-o fa-fw"></i>
                                                        ...
                                                        <div class="input-group">
                                                            ...
                                                            <div class="input-group">
                                                                <input type="checkbox" name="is_amazing"
                                                                       value="on" {{ old('is_amazing',$product->promotionPrice->is_amazing == 1)?'checked':''}}>
                                                            </div>
                                                        </div>
                                                    </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="stock" name="stock"
                                                       ...
                                                       class="form-control input-sm stock"
                                                       placeholder=""/>
                                            </div>
                                            @if ($errors->has('stock'))
                                                <span class="help-block">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="weight" name="weight"
                                                       ...
                                                       class="form-control input-sm weight"
                                                       placeholder=""/>
                                            </div>
                            ...
                            @if (sc_config('product_length'))
                                ...
                                @if ($product->kind == SC_PRODUCT_SINGLE || $product->kind == SC_PRODUCT_BUILD)
                                    ...
                                    <div class="form-group  {{ $errors->has('length_class') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-sm-8">
                                            <select class="form-control input-sm length_class select2"
                                                    style="width: 100%;"
                                                    name="length_class">
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="length" name="length"
                                                       ...
                                                       class="form-control input-sm length"
                                                       placeholder=""/>
                                            </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="height" name="height"
                                                       ...
                                                       class="form-control input-sm height"
                                                       placeholder=""/>
                                            </div>
                                        ...
                                        <div class="col-sm-8">
                                            <div class="input-group">
                                                ...
                                                <input type="number" style="width: 100px;" id="width" name="width"
                                                       ...
                                                       class="form-control input-sm width"
                                                       placeholder=""/>
                                            </div>
                                            @if ($errors->has('width'))
                                                <span class="help-block">
                                        ...
                                        <div class="col-sm-8">
                                            @foreach ( $virtuals as $key => $virtual)
                                                <label class="radio-inline"><input type="radio" name="virtual"
                                                                                   value="{{ $key }}"
                                                            {{ (old('virtual',$product->virtual) == $key)?'checked':'' }}>{{ $virtual }}
                                                </label>
                                            @endforeach
    ...
    <script type="text/javascript">
        ...
        function process_product_type_form() {
            ...
            $.ajax({
                ...
                type: "POST",
                data: {"product_type": product_type, 'product_id':{{$product['id']}}, "_token": "{{csrf_token()}}"},
                async: false,
                success: function (data) {
                    console.log('bib');
                    for (var i = 0; i < data.length; ++i) {

                        $('.attrs').append("<h4>" + data[i]['name'] + "<h4><br>");
                        ...
                        for (var j = 0; j < data[i]['attrs'].length; ++j) {
                            ...
                            if (data[i]['attrs'][j]['input_type'] == 'select') {
                                $.ajax({
                                    ...
                                    success: function (attrInput) {
                                        ...
                                        for (var w in attrInput) {
                                            ...
                                            if (attrInput[w]['input'] == data[i]['attrs'][j]['value']) {
                                                var selected = 'selected="selected"';
                                            } else {
                                                var selected = '';
                                            }
                                            temp = temp + '<option  value="' + attrInput[w]['input'] + '" ' + selected + '>' + attrInput[w]['input'] + '</option>';
                                        }
                                        $('.attrs').append("<div class='form-group'>" +
                                            "<label for='attr_text_" + j + "' class='col-sm-2  control-label'+>" + data[i]['attrs'][j]['name'] + "</label>"
                                            + "<div class=\"col-sm-8\">"
                                            + "<select name='attr_text[" + data[i]['id'] + "][" + data[i]['attrs'][j]['attr_id'] + "]' id='attr_text_" + i + "_" + j + "' class=\"form-control\" >"
                                            + temp
                                            + "</select>"
                                            + "</div></div>"
                                        );
                                ...
                                $('.attrs').append("<div class='form-group relatioan_control' data-name ='" + data[i]['attrs'][j] + "'>" +
                                    ...
                                    + "<div class=\"input-group\">"
                                    + " <span class=\"input-group-addon\"><i class=\"fa fa-pencil fa-fw\"></i></span>"
                                    + "<select value='' id='attr_text_" + i + "_" + j + "' class='form-control select2  input-sm'   multiple='multiple'  name='attr_text[" + data[i]['id'] + "][" + data[i]['attrs'][j]['attr_id'] + "][]' >"
                                    + "</select></div></div></div>"
                                );
                                $('.select2').select2();
                                $.ajax({

                                    url: "{{route('admin_product.getRelatedProducts')}}",
                                    type: "POST",
                                    data: {
                                        'product_id':{{$product['id']}},
                                        'attr_id': data[i]['attrs'][j]['id'],
                                        "_token": "{{csrf_token()}}"
                                    },
                                    async: false,
                                    success: function (data) {
                                        ...
                                        for (o in data)
                                            ...
                                            $("#attr_text_" + i + "_" + j).append('<option value="' + o + '" selected>' + data[o] + '</option>');
                                    }
                                });

                            } else if (data[i]['attrs'][j]['input_type'] == 'enumeration') {
                                var selectedEnumrations = [];
                                $('input[name="selected_enumrations[]"]').each(function () {
                                    selectedEnumrations.push($(this).val());
                                });
                                ...
                                $('.attrs').append("<div class='form-group ' data-name ='" + data[i]['attrs'][j] + "'>" +
                                    ...
                                    + "<div class=\"input-group\">"
                                    + " <span class=\"input-group-addon\"><i class=\"fa fa-pencil fa-fw\"></i></span>"
                                    + "<select value='' id='attr_text_" + i + "_" + j + "' class='form-control select2 input-sm enumeration_options'   multiple='multiple'  name='attr_text_enumeration[" + data[i]['id'] + "][" + data[i]['attrs'][j]['attr_id'] + "][]'  >"
                                    + "</select></div></div></div>"
                                );
                                ...
                                $.ajax({
                                    ...
                                    type: "POST",
                                    data: {
                                        "attr_id": data[i]['attrs'][j]['attr_id'], "_token": "{{csrf_token()}}"
                                    },
                                    ...
                                    success: function (enumeration) {
                                        ...
                                        for (var p in enumeration) {
                                            ...
                                            for (s in selectedEnumrations) {
                                                if (selectedEnumrations[s] == p) {
                                                    selected = 'selected="selected"';
                                                    break;
                                                }
                                            }
                                            if (enumeration[p] != null) {
                                                $('.enumeration_options').append('<option value="' + p + '" ' + selected + '>' + enumeration[p] + '</option>');
                                            }
                                ...
                                $('.attrs').append("<div class='form-group'>" +
                                    ...
                                    + "<div class=\"input-group\">"
                                    + " <span class=\"input-group-addon\"><i class=\"fa fa-pencil fa-fw\"></i></span>"
                                    + "<input type='text' value='" + data[i]['attrs'][j]['value'] + "' id='attr_text_" + i + "_" + j + "' class='form-control input-sm' name='attr_text[" + data[i]['id'] + "][" + data[i]['attrs'][j]['id'] + "]' >"
                                    + "</div></div></div>"
                                );
                            }
                        }

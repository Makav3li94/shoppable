...
@section('center')
    ...
    <section class="row fix-col-lg flex-column-reverse flex-lg-row">
        ...
        <!--Banner Right-->
            ...
            <!--Promo Features-->
            <div class="promo-features bg-white cart-shadow-radius px-2 py-2 py-lg-3 mt-3 mt-lg-0">
                <a href="#" class="item">
                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="60"
                         height="60" viewBox="0 0 185 117">
                        <defs>
                ...
                <a href="#" class="item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 109 119">
                        <g fill="none" fill-rule="evenodd">
                            <g fill-rule="nonzero">
                                <path fill="#F05562"
                ...
                <a href="#" class="item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 126 120">
                        <g fill="none" fill-rule="evenodd">
                ...
                <a href="#" class="item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 117 120">
                        <g fill="none" fill-rule="evenodd">
                            <path fill="#F05562"
                ...
                <a href="#" class="item">
                    <svg xmlns="http://www.w3.org/2000/svg" width="60" height="60" viewBox="0 0 101 120">
                ...
                <div class="row amazing cart-shadow-radius">
                    <div class="col-9 right bg-white" id="amazing-content">
                        <div class="item active">
                            <a href="" aria-label="تبلت ایسوس" title="تبلت ایسوس"></a>
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/001.jpg" class="img-fluid" alt="">
                                </div>
                        ...
                        <div class="item">
                            <a href="" aria-label="ادو پرفیوم زنانه" title="ادو پرفیوم زنانه"></a>
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/002.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="product">
                                        <h2>ادو پرفیوم زنانه</h2>
                                        <ul>
                                            <li>محدوده ظرفیت: بیشتر از 15 هزار میلی‌آمپر‌ساعت</li>
                                            <li>قابلیت های ویژه: شارژ شدن سریع پاوربانک امکان</li>
                                        </ul>
                                    </div>
                                    <div class="sale-end">
                                        <p>تمام شد</p>
                        ...
                        <div class="item">
                            <a href="" aria-label="ادو پرفیوم زنانه"></a>
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/003.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="price mt-2">
                                        <p class="old-price">۲,۳۵۰,۰۰۰<span>تومان</span></p>
                        ...
                        <div class="item">
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/004.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="product">
                                        <h2>4 شارژر همراه انکر</h2>
                                        <ul>
                                            <li>محدوده ظرفیت: بیشتر از 15 هزار میلی‌آمپر‌ساعت</li>
                                            <li>قابلیت های ویژه: شارژ شدن سریع پاوربانک امکان</li>
                                        </ul>
                        ...
                        <div class="item">
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/005.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="product">
                                        <h2>5 شارژر همراه انکر</h2>
                                        <ul>
                                            <li>محدوده ظرفیت: بیشتر از 15 هزار میلی‌آمپر‌ساعت</li>
                                            <li>قابلیت های ویژه: شارژ شدن سریع پاوربانک امکان</li>
                                        </ul>
                        ...
                        <div class="item">
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/006.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="price mt-2">
                                        <p class="old-price">۲,۳۵۰,۰۰۰<span>تومان</span></p>
                        ...
                        <div class="item">
                            ...
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/007.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="product">
                                        <h2>7 شارژر همراه انکر</h2>
                                        <ul>
                                            <li>محدوده ظرفیت: بیشتر از 15 هزار میلی‌آمپر‌ساعت</li>
                                            <li>قابلیت های ویژه: شارژ شدن سریع پاوربانک امکان</li>
                                        </ul>
                        ...
                        <div class="item">
                            <a href="" aria-label=" پرفیوم زنانه"></a>
                            <div class="row align-items-center h-100">
                                <div class="col-md-5 col-lg-5">
                                    <img src="asset/files/product/500-500/003.jpg" class="img-fluid" alt="">
                                </div>
                                <div class="col-md-7 col-lg-6 offset-lg-1 h-100 d-flex flex-column justify-content-around">
                                    <div class="product">
                                        <h2>10 آخری شارژر همراه انکر</h2>
                                        <ul>
                                            <li>محدوده ظرفیت: بیشتر از 15 هزار میلی‌آمپر‌ساعت</li>
                                            <li>قابلیت های ویژه: شارژ شدن سریع پاوربانک امکان</li>
                                        </ul>
                    ...
                    <div class="col-3 left px-0 shave-amazing-name" id="amazing-tab">
                        <h3 aria-label="1" class="active"><strong>شارژر همراه</strong></h3>
                        <h3 aria-label="2"><strong>ماشین اصلاح صورت</strong></h3>
                        <h3 aria-label="3"><strong>ست هدیه چرم دیبا</strong></h3>
                        <h3 aria-label="4"><strong>مجموعه سه عددی چمدان</strong></h3>
                        <h3 aria-label="5"><strong>سرویس پخت و پز</strong></h3>
                        <h3 aria-label="6"><strong>مجموعه 78 عددی آچار و سری بکس و پیچ گوشتی ساتاگود مدل
                                G-10007</strong></h3>
                        <h3 aria-label="7"><strong>خود تراش مردانه</strong></h3>
                        <h3 aria-label="8"><strong>گریل</strong></h3>
                        <h3 aria-label="9"><strong>پودر ظرفشویی</strong></h3>
                        <h3 aria-label="10"><strong>گوشی سامسونگ</strong></h3>

                                    ...
                                    <tr class="row_cart form-group {{ session('arrErrorQty')[$product->id] ?? '' }}{{ (session('arrErrorQty')[$product->id] ?? 0) ? ' has-error' : '' }}">
                                        ...
                                        <td class="cart-col-qty">
                                            <div class="cart-qty">
                                                ...
                                                <button type="button" onclick="buttonQty($(this), 'increase');">+
                                                </button>
                                            </div>
                                            <span class="text-danger item-qty-{{$item->id}}"
                                            ...
                                            <select class="form-control" name="address_process" style="width: 100%;"
                                                ...
                                                @foreach ($addressList as $k => $address)
                                                    <option value="{{ $address->id }}" {{ (old('address_process') ==  $address->id) ? 'selected':''}}>
                                                        - {{ $address->first_name. ' '.$address->last_name.', '.$address->address1.' '.$address->address2 }}</option>
                                                @endforeach

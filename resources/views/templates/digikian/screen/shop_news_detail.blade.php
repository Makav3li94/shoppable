            ...
            <div class="col-lg-9 h-100">
                ...
                <article class="post cart-shadow-radius bg-white px-3 px-md-5 py-2 py-md-3">
                    ...
                    <div class="breadcrumb-defualt py-2 py-md-3">
                        <p><span><a href="index.html"><i class="d-inline-flex align-middle ml-1 mdi mdi-home"></i>دیجی کیان</a></span><span><a
                                        href="#">تکنولوژی</a></span><span><a href="#">موبایل و گجت</a></span>سایت‌های مطرح درباره‌ی
                            گلکسی نوت ۹ چه می‌گویند؟</p>
                    </div>
                    <!--End Breadcrumb-->
                    ...
                    <div class="header py-2">
                       <h1>
                        ...
                        <ul>
                            ...
                            <li class="date"><i class="d-inline-flex align-middle ml-1 mdi mdi-clock"></i>۱۳۹۶/۰۷/۰۱ - ۱۴:۲۵
                            </li>
                ...
                <div class="bg-white mt-3 p-2 p-md-3" id="questions">
                    <p class="title"><i
                                class="d-inline-flex align-middle ml-1 mdi mdi-comment-text-multiple-outline mdi-36px"></i>دیدگاه
                        خود را در مورد نوشته مطرح نمایید.</p>
                    ...
                    <form class="mb-2 mb-md-5" action="">
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <input type="text" dir="ltr" class="form-control text-left"
                        ...
                        <div class="form-group send-qustion">
                            ...
                            <div class="custom-control custom-checkbox">
                                ...
                                <label class="custom-control-label" for="QuestionCheck">اولین پاسخی که به پرسش من داده شد،
                                    از طریق ایمیل به من اطلاع دهید.<br/>با انتخاب دکمه “ثبت پرسش”، موافقت خود را با قوانین
                                    انتشار محتوا در دیجی کیان اعلام می کنم.</label>
                            </div>
                        </div>
                    </form>
                    <!--End Send Question-->
                                ...
                                <ul>
                                        ...
                                        <div class="question">
                                            ...
                                            <div class="left px-2 p-md-3">
                                                <div class="header wrapper-text">
                                                    <p>حدود یک ماه هست که گوشی رو دارم و ازش کاملا راضیم ، تجربه کار با فیس
                                                        آیدی خیلی جذاب و لذت بخشه . دوربین با کیفیت ، بدنه ی زیبا و سیستم
                                                        عامل روان آی او اس از جمله ویژگی های بارز این محصول هستن.</p>
                                                    <p> به دوستانی که قبلا آیفون داشتن و الان به فکر ارتقا هستن و با قیمتش
                                                        مشکلی ندارن پیشنهاد می کنم.</p>
                                                </div>
                                                <div class="footer">
                                                    <p>۴ تیر ۱۳۹۷</p>
                                                    <a rel="nofollow" data-toggle="collapse" href="#collapseQuestion-1"
                                                       role="button" aria-expanded="false"
                                                       aria-controls="collapseQuestion-1">به این دیدگاه پاسخ دهید</a>
                                                </div>
                                            </div>
                                        </div>
                                        <!--Answer-->
                                                    ...
                                                    <div class="col-12 p-0 first-col">
                                                        ...
                                                        <form class="mt-2 mt-md-4" action="">
                                                            ...
                                                            <div class="form-group send-reply">
                                                                <button type="submit" class="btn btn-info btn-lg">ثبت پاسخ
                                                                </button>
                                                                <div class="custom-control custom-checkbox">
                                                                    <input class="custom-control-input" id="answerCheck-1"
                                                                           type="checkbox">
                                                                    <label class="custom-control-label" for="answerCheck-1">با
                                                                        انتخاب دکمه "ثبت پاسخ"، موافقت خود را با<br><a
                                                                                href="">قوانین انتشار محتوا</a> در دیجی‌کیان
                                                                        اعلام می‌کنم.</label>
                                                                </div>
                                                            </div>
                                                        </form>
                                    ...
                                    <li>
                                        <div class="question">
                                            ...
                                            <div class="left px-2 p-md-3">
                                                <div class="header wrapper-text">
                                                    <p>این گوشی حرف نداره فوق العاده ای هست بهترین محصول اپل اونایی که از
                                                        سامسونگ یا سام هنگ تعریف میکنن هنوز این گوشی دستشون نگرفتن .خرید آن
                                                        را توصیه کنیم احتمالاً هیچ خریداری از خرید آیفون 10 پشیمان نخواهد
                                                        شد.</p>
                                                </div>
                                                <div class="footer">
                                                    <p>۱۳ شهریور ۱۳۹۶</p>
                                                    <a rel="nofollow" data-toggle="collapse" href="#collapseQuestion-2"
                                                       role="button" aria-expanded="false"
                                                       aria-controls="collapseQuestion-1">به این دیدگاه پاسخ دهید</a>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-12 p-0 first-col">
                                                        ...
                                                        <form class="mt-2 mt-md-4" action="">
                                                            ...
                                                            <div class="form-group send-reply">
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    <input class="custom-control-input" id="answerCheck-2"
                                                                           type="checkbox">
                                                                    <label class="custom-control-label" for="answerCheck-2">با
                                                                        انتخاب دکمه "ثبت پاسخ"، موافقت خود را با<br><a
                                                                                href="">قوانین انتشار محتوا</a> در دیجی‌کیان
                                                                        اعلام می‌کنم.</label>
                                                                </div>
                                    ...
                                    <li>
                                        <div class="question">
                                            ...
                                            <div class="left px-2 p-md-3">
                                                <div class="header wrapper-text">
                                                    <p>این گوشی از همه نظر عالی هست، قیمتش یکم بالا هست که اونم شخصا راضیم
                                                        چون باعث میشه خاص باشه ، هیچ ایرادی نمی تونم پیدا کنم و واقعا بدون
                                                        هیچ تعصبی نسبت به مارکش میگم عالیه، پرچمدارای برندهای دیگه رو هم
                                                        داشتم و اصلا قابل مقایسه واسم نیستن، کسایی که میتونن بخرن شک نکنن و
                                                        مطمئن باشن از خریدشون نهایت لذت رو میبرن</p>
                                                </div>
                                                <div class="footer">
                                                    <p>۲۰ شهریور ۱۳۹۶</p>
                                                    <a rel="nofollow" data-toggle="collapse" href="#collapseQuestion-3"
                                                       role="button" aria-expanded="false"
                                                       aria-controls="collapseQuestion-3">به این دیدگاه پاسخ دهید</a>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="col-12 p-0 first-col">
                                                        ...
                                                        <form class="mt-2 mt-md-4" action="">
                                                            ...
                                                            <div class="form-group send-reply">
                                                                ...
                                                                <div class="custom-control custom-checkbox">
                                                                    <input class="custom-control-input" id="answerCheck-3"
                                                                           type="checkbox">
                                                                    <label class="custom-control-label" for="answerCheck-3">با
                                                                        انتخاب دکمه "ثبت پاسخ"، موافقت خود را با<br><a
                                                                                href="">قوانین انتشار محتوا</a> در دیجی‌کیان
                                                                        اعلام می‌کنم.</label>
                                                                </div>
                                        ...
                                        <div class="reply">
                                            ...
                                            <div class="left px-2 p-md-3">
                                                <div class="header wrapper-text">
                                                    <p>سلام من یه تلویزیون اندروید سونی دارم میخوام از بازی های خود تلویزیون
                                                        استفاده کنم آیا این دسته بازی بهش وصل میشه؟</p>
                                                </div>
                                                <div class="footer">
                                                    <p>۴ آبان ۱۳۹۶</p>
                                                    <div class="is-helpful">
                                        ...
                                        <div class="reply">
                                            ...
                                            <div class="left px-2 p-md-3">
                                                <div class="header wrapper-text">
                                                    <p>من خودم ایفون داشتم بدون شک کیفیت محصولات اپل فوق العاده هستن ولی
                                                        باید منصفانه صحبت کنیم که محصولات اپل از طرف امریکا برای ایران تحریم
                                                        هست یعنی مواجه شدن با ارور 1009 و برداشتن اپلیکیشن های ایرانی از اپ
                                                        استور . بنده به شخصه با پشتیبانی اپل داخل امریکا تماس گرفتم و در
                                                        مورد این که چرا اپلیکیشن های ایرانی بسته شدن و قابل دانلود نبودن
                                                        باهاشون صحبت کردم و گفتن بهم که شما برا چی گوشی ای که هیچ نمایندگی و
                                                        خدماتی داخل کشورتون نداره رو خریداری میکنید منم گفتم به دلیل کیفیت
                                                        بالایی که داره و گفتن به دلیل مشکلات سیاستی که بین کشور ما و شما
                                                        وجود داره متاسفانه هیچ راهی برای برداشتن ارور های 1009 و گذاشتن اپ
                                                        های ایرانی نیس . دیگه بازم به سلیقه خودتون بستگی داره و بس .</p>
                                                </div>
                                                <div class="footer">
                                                    <p>۱ اردیبهشت ۱۳۹۷</p>
                                                    <div class="is-helpful">
            ...
            <div class="col-lg-3 mt-3 mt-lg-0 pr-lg-0 sidebar-post">
                <div class="box-sidebar cart-shadow-radius bg-white p-3 mb-3">
                    ...
                    <div class="related-post">
                        <a href="#" class="item">
                            ...
                            <div class="content">
                                <h3 class="shave-related-post">گلکسی نوت ۹ در مقایسه با نسل قبلی خود چه تفاوتی هایی داشته
                                    است؟</h3>
                            </div>
                        </a>
                        <a href="#" class="item">
                            ...
                            <div class="content">
                                <h3 class="shave-related-post">کیفیت عکس‌های گرفته‌شده با دو گوشی سامسونگ ایج و تشابه های
                                    آنها</h3>
                            </div>
                        </a>
                        <a href="#" class="item">
                    ...
                    <div class="related-post">
                        <a href="#" class="item">
                            ...
                            <div class="content">
                                ...
                                <p class="date"><i class="d-inline-flex align-middle ml-1 mdi mdi-clock"></i>۱۳۹۶/۰۷/۰۱ -
                                    ۱۴:۲۵</p>
                            </div>
                        </a>
                        <a href="#" class="item">
                            ...
                            <div class="content">
                                <h3 class="shave-related-post">نگاه نزدیک به گوشی پیکسل ۳ ایکس‌ال گوگل پیش از رونمایی
                                    رسمی</h3>
                                <p class="date"><i class="d-inline-flex align-middle ml-1 mdi mdi-clock"></i>۱۳۹۶/۰۷/۰۱ -
                                    ۱۴:۲۵</p>
                            </div>
                ...
                <div class="box-sidebar cart-shadow-radius bg-white p-3 mb-3">
                    ...
                    <div class="wrapper-text">
                        <p class="text-justify">دیجی کیان به عنوان یکی از قدیمی‌ترین فروشگاه های اینترنتی با بیش از یک دهه
                            تجربه، با پایبندی به سه اصل کلیدی، پرداخت در محل، 7 روز ضمانت بازگشت کالا و تضمین اصل‌بودن کالا،
                            موفق شده تا همگام با فروشگاه‌های معتبر جهان، به بزرگ‌ترین فروشگاه اینترنتی ایران تبدیل شود. به
                            محض ورود به دیجی کیان با یک سایت پر از کالا رو به رو می‌شوید! هر آنچه که نیاز دارید و به ذهن شما
                            خطور می‌کند در اینجا پیدا خواهید کرد.</p>
                    </div>
                </div>

<footer>
    <section class="container-fluid bg-back-to-top">
        <div class="container px-2 px-md-5">
            <div class="row">
                <div class="col-lg-12">
                    <!--Back To Top-->
                    <div class="back-to-top py-2">
                        <p id="back-to-top">
                            <i class="d-inline-flex align-middle justify-content-center ml-2 mdi mdi-chevron-up"></i>
                            {{trans('front.go_up')}}
                        </p>
                    </div>
                    <!--End Back To Top-->
        ...
        <div class="container px-2 px-md-5">
            <div class="row">
                <div class="col-lg-12 footer-header">
                    <!--Promo Features-->
                    <div class="promo-features-footer px-2 py-2">
                        <a href="#" class="item">
                            <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                 width="75" height="75" viewBox="0 0 185 117">
                                <defs>
                ...
                <div class="col-lg-12 footer-body py-2 py-md-3">
                    <div class="row">
                        <!--Other Link-->
                        <div class="col-lg-8">
                            <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="row align-items-center">
                                <!--Newsletter-->
                                <div class="col-md-6 col-lg-12 newsletter">
                                    <p>{{ trans('front.subscribe.subscribe_des') }}</p>
                                    <form action="{{ route('subscribe') }}" method="post">
                                        <div class="input-group">
                                            <input type="text" dir="ltr" name="subscribe_email"
                                                   class="form-control text-left"
                                                   placeholder="{{ trans('front.subscribe.subscribe_email') }}">
                                            <div class="input-group-append">
                                                <button class="btn btn-info"
                                                        type="submit">{{ trans('front.subscribe.title') }}</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
                ...
                <div class="col-lg-12 footer-footer py-2 py-md-3">
                    <div class="row align-items-center">
                        <!--Contact Us-->
                        <div class="col-md-8">
                            <div class="contact">
    ...
    <section class="container-fluid bg-copyright">
        <div class="container px-2 px-md-5">
            <div class="row copyright py-2 py-md-3">
                <div class="col-md-7">
                    <!--About Us-->
                    <div class="about-us">
                        <h2>فروشگاه اینترنتی دیجی کیان، بررسی، انتخاب و خرید آنلاین</h2>
                        <p class="shave-copyright">
                            @php
                                $about = \App\Models\ShopPageDescription::where([['lang',config('app.locale')],['page_id',1]])->first()
                            @endphp
                            @if(!empty($about))
                                {{ str_limit($about,300) }}
                            @endif
                        </p>
                        <a href=""> {{ trans('front.about') }}</a>
                    </div>
                    <!--End About Us-->
                </div>
                <div class="col-md-5">
            ...
            <div class="row ">
                <div class="col-12">
                    <!--Copyright Text-->
                    <div class="copyright-text pb-2 py-mb-3">
                        <p> استفاده از مطالب فروشگاه اینترنتی دیجی کیان فقط برای مقاصد غیرتجاری و با ذکر منبع بلامانع
                            است. کلیه حقوق این سایت متعلق به شرکت نوآوران فن آوازه (فروشگاه آنلاین دیجی کیان)
                            می‌باشد.</p>
                    </div>
                    <!--End Copyright Text-->
                </div>
...
<div id="mask-filter" class="mask-filter">
    <div class="box-filter-looking">
        <img src="images/logo-xs.svg" alt="">
        <p>لطفا منتظر باشید...</p>
    </div>
</div>
<!--End Background Code and Modal List-->
...
<script type="text/javascript" src="{{asset($templateFile.'/asset/js/script.js')}}"></script>
</body>
</html>
